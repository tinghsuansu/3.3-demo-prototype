...
`;
  ...
  function buildScreens() {
    return `
      ...
      <div id="c01-screen-C2_2" class="c01-screen c01-c2_2">
        ...
        <div class="c01-c2_2-exhibit" data-action="to-C3" style="top:292px; left:66px;">Meat-shaped Stone</div>
      ...
      <div id="c01-screen-C4" class="c01-screen c01-c4">
        ...
        <div class="c01-c4-actions">
          <button class="c01-c4-close" data-action="to-C5">✕</button>
        </div>
      </div>
  ...
  function mountC01(container) {
    ...
    // 2. Inject CSS (once per document)
  ...
  if (typeof window !== 'undefined') {
    window.mountC01 = mountC01;
  }

})();

if (typeof module !== 'undefined') module.exports = { mountC01 };
